...
conditions = [
    ((df_full['(Mg+Fe)/Si'] >= 1.7) & (df_full['(Mg+Fe)/Si'] <= 2.3)) | (df_full['olivine oxide score'] >= 0.92),
    ((df_full['(Mg+Fe+Ca)/Si'] > 0.85) & (df_full['(Mg+Fe+Ca)/Si'] < 1.15)) | ((df_full['pyroxene oxide score'] >= 0.92) |
